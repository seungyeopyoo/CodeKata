...
// step 1. overwrite_string 의 length를 구하고
// step 2. my_string에서 0부터 s 만큼 slice + overwrite_string + 뒷부분

const solution = function (my_string, overwrite_string, s) {
	let overwriteLength = overwrite_string.length;

	return (
		my_string.slice(0, s) +
		overwrite_string +
		my_string.slice(s + overwriteLength)
	);
};
