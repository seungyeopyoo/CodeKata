...
// flag[i]가 false라면 X에서 마지막 arr[i]개의 원소를 제거한 뒤 X를 return 하는 solution
...
// step 1. flag를 순회하면서 true면 x.push arr[i] arr[i] x2 만큼 추가
// step 2. false면 pop을 arr[i]만큼 반복

const solution = function (arr, flag) {
	const result = [];
