...
// step 1. myString에서 pat의 위치를 선언한다.  lastIndexOf
// step 2. myString slice 0 , step1 + pat return

const solution = function (myString, pat) {
	const slicedStr = myString.lastIndexOf(pat);

	return myString.slice(0, slicedStr) + pat;
};
