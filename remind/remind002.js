...
// step 1. 최대한 많은 부서를 지원해주는게 목표니까 d를 정렬한다 오름차순으로.
// step 2. d의 합이 budget 보다 작을경우에는 d.length를 반환한다.
// step 3. 아닐 경우에는 하나씩 더해주다가 더 커지면 그 전 값을 반환한다.

const solution = function (d, budget) {
  d.sort((a, b) => a - b);
  let sum = 0;
  let count = 0;
