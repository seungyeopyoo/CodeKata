...
// step 1. 주어진 wallpaper을 2차원 배열로 변경한다.
// step 1-1. 가로길이는 wallpaper[0].length 세로길이는 wallpaper.length
// step 1-2. wallpaper에 있는 #의 위치의 좌표를 계산한다
// step 2. step 1-2에서 계산된 좌표위치 중에서 최솟값 최댓값을 뽑아내서 return 한다 . 인데 마지막의 최댓값 +1해줘야 감싸지네

const solution = function (wallpaper) {
	let minX = 50;
	let minY = 50;
	let maxX = 0;
	let maxY = 0;
