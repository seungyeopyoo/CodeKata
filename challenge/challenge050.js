...
// step 1. nums의 중복을 제거하고 선언한다. new Set 이든 뭐든
// step 2. nums.length / 2 를  step1.length랑 비교해서 더 작은 놈을 return
// set 객체는 length가 안되네 size로 출력함

const solution = function (nums) {
	const noDuplicate = new Set(nums).size;

	const maxPokemon = nums.length / 2;

	return Math.min(noDuplicate, maxPokemon);
};
