...
// ["may", "kein", "kain", "radi"]		[5, 10, 1, 3]		[["may"],["kein", "deny", "may"], ["kon", "coni"]]														 bb [5, 15, 0]
...
// step 1. name과 yearning을 객체로 변환
// step 2. photo를 순회하며 각 사진의 추억 점수를 계산
// step 3. 계산된 추억 점수를 배열에 담아 return

const solution = function (name, yearning, photo) {
	const nameYearning = {};
	const result = [];
